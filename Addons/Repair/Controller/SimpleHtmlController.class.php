 ...
 * Redistributions of files must retain the above copyright noRepair.
 *
...
// NoRepair the \[ starting the attbute?  and the @? following?  This implies that an attribute can begin with an @ sign that is not captured.
