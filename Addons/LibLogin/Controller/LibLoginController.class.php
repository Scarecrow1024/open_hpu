...
namespace Addons\LibLogin\Controller;
use Home\Controller\AddonsController;

class LibLoginController extends AddonsController{
    public function ser(){
        $this->display();
    }
    ...
    public function xujie(){
        ...
        if(strstr($content, "该书已预约")){
            $this->error('续借失败，该书已被预约', U('/addon/LibLogin/LibLogin/grzx/'));
        }else{
            $this->success('续借成功', U('/addon/LibLogin/LibLogin/grzx/'));
        }
        //echo $post;
