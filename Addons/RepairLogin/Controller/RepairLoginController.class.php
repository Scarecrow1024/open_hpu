<?php
namespace Addons\RepairLogin\Controller;
use Home\Controller\AddonsController;

class RepairLoginController extends AddonsController{
    public function index(){
        ...
        if((($data[1][5]=='')||($data[1][6]==''))){
            $this->error("等待跳转完善个人信息后再来报修",addons_url ("RepairLogin://RepairLogin/grzx/openid/".$openid),1);
        }else{
    ...
    public function update(){
        ...
        $content = curl_exec ( $ch );
        curl_close ( $ch );
        $this->success('个人资料修改成功',addons_url ("RepairLogin://RepairLogin/index/openid/".$openid),1);
    }
